...
DEFAULT_POLICY = {
    ...
    "execution_enabled": True,    # enabled — real execution via approved callback
...
def evaluate_add_datafile_policy(
    ...
    if result["execution_enabled"]:
        ...
        result["policy_messages"].append("Execution is disabled by policy — contact your DBA lead.")
